...
fn indirect_skip() {
    ...
    let references_4 = build_dag(&committee, &mut storage, None, leader_round_4);
    ...
    let connections_with_leader_4 = committee
        ...
        .collect();
    references_5.extend(build_dag_layer(connections_with_leader_4, &mut storage));
    ...
    let connections_without_leader_4 = committee
        ...
        .collect();
    references_5.extend(build_dag_layer(connections_without_leader_4, &mut storage));
